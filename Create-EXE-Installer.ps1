# FamBudget EXE Installer Creator
...
echo rmdir /s /q "%APPDATA%\Microsoft\Windows\Start Menu\Programs\FamBudget" 2^>nul
echo.
echo echo ========================================
...
del "%USERPROFILE%\Desktop\FamBudget Setup.lnk" 2>nul
